...
:-:|---|:-:
[<img src="logos/grc.png" title="Genome Reference Consortium" width=500>](https://www.ncbi.nlm.nih.gov/grc)  | GRC makes available the human reference genome (HG19 or HG38) used in nearly every step of the pipeline. | N/A
