...
[<img src="logos/ensembl.png" title="Ensembl">](http://www.ensembl.org)  | The ensembl database is used extensively throughout our algorithms: <br/> - The exome is roughly defined as the exons of all canonical transcripts of all genes as defined in ensembl <br/> - Ensembl's protein features and splice data are used for interpretation of structural variants. | [link](http://www.ensembl.org/info/about/legal/disclaimer.html)
