...
[<img src="logos/ncbi.png" title="NCBI">](https://www.ncbi.nlm.nih.gov/genome/viruses)  | VirusBreakend exhaustively searches the DNA for viral presence and integration into the human DNA. Viral reference genomes from NCBI are used for that purpose.  | - [about](https://www.ncbi.nlm.nih.gov/home/about) <br /> - [reference](https://pubmed.ncbi.nlm.nih.gov/25428358)
...
[<img src="logos/pharmgkb.png" title="PharmGKB">](https://www.pharmgkb.org) | The PharmGKB database is used as a reference for pharmacogenetic evidence regarding variants found by the pipeline. | - [license](https://www.pharmgkb.org/page/dataUsagePolicy) <br /> - [reference](https://pubmed.ncbi.nlm.nih.gov/22992668)
...
[<img src="logos/ipd.png" title="IPD">](https://www.ebi.ac.uk/ipd/imgt/hla) | The IPD-IMGT/HLA database is used as the source for all HLA types previously found in humans | - [about](https://www.ebi.ac.uk/about) <br /> - [reference](https://academic.oup.com/nar/article/48/D1/D948/5610347)
