...
[<img src="logos/ensembl.png" title="Ensembl">](http://www.ensembl.org)  | The ensembl database is used extensively throughout our algorithms: <br/> - The exome is roughly defined as the exons of all canonical transcripts of all genes as defined in ensembl <br/> - Protein features and splice data are used for interpretation of structural variants is gathered via ensembl. | [link](http://www.ensembl.org/info/about/legal/disclaimer.html)
...
[<img src="logos/ucsc.png" title="UCSC">](https://genome.ucsc.edu)| UCSC's definition of replication timing of parts of the DNA is used by the pipeline. This is done to be able to distinguish variants in parts of the DNA that replicate early versus variants in parts that replicate late. | [link](https://genome.ucsc.edu/conditions.html)
[<img src="logos/giab.png" title="Genome in a Bottle">](https://www.nist.gov/programs-projects/genome-bottle) | The GIAB consortium's high confidence regions are used by the pipeline. Thresholds are lowered when calling variants in a high confidence region vs low confidence region. | N/A
