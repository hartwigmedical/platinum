...
- [A GCP project](https://cloud.google.com/resource-manager/docs/creating-managing-projects). IMPORTANT: See specifics below.
...
conservative. At the least (replace `europe-west4` with your chosen region):

```
+------------------+--------------+-----------------+
|       Name       |    Region    | Requested Limit |
+------------------+--------------+-----------------+
|       CPUS       | europe-west4 |        64       |
| CPUS_ALL_REGIONS |    GLOBAL    |        64       |
|   SSD_TOTAL_GB   | europe-west4 |       5000      |
+------------------+--------------+-----------------+
```
