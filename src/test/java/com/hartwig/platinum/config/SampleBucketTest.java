...
public class SampleBucketTest {
    ...
    public void createsSampleConfigurationFromBucketPath() {
        ...
        assertThat(sampleConfiguration.normal().orElseThrow().fastq().get(0).read1()).isEqualTo(
                "bucket/COLO829/NORMAL/COLO829R" + "/COLO829R_R1_001.fastq" + ".gz");
        assertThat(sampleConfiguration.normal().orElseThrow().fastq().get(0).read2()).isEqualTo(
                "bucket/COLO829/NORMAL/COLO829R" + "/COLO829R_R2_001.fastq" + ".gz");
        assertThat(sampleConfiguration.tumors().get(0).fastq().get(0).read1()).isEqualTo(
                "bucket/COLO829/TUMOR/COLO829T/COLO829T_R1_001" + ".fastq.gz");
        assertThat(sampleConfiguration.tumors().get(0).fastq().get(0).read2()).isEqualTo(
                "bucket/COLO829/TUMOR/COLO829T/COLO829T_R2_001" + ".fastq.gz");
    }
